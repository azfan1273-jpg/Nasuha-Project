...
class _ReportDialogState extends State<ReportDialog> {
  int _selectedTab = 0; // 0: Omset, 1: Pendapatan, 2: Pengeluaran, 3: Piutang
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  // 3. JUDUL TAB LAPORAN (SISI KANAN)
                  Align(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            // SPACER: Mendorong ikon Chart turun ke paling bawah
                            const Spacer(),
                            
                            // IKON CHART (DI POSISI PALING BAWAH SIDEBAR)
                            Container(
                              width: 38,
                              height: 38,
                              decoration: BoxDecoration(
